...
#### B. Filter barcodes by reads and proportion cutoffs within files
...
##### The list of questionable and good barcodes was written to files in the "fish_dictionaries" folder.
